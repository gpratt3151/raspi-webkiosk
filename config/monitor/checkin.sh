...
"signs,hostname=screen0,location=godojo.south.pointwest.coppell.texas,type=Raspberry_Pi_Zero_W mac_address=\"${MAC}\",ip_address=\"${IP}\",load_1_min=${LOAD_1},load_5_min=${LOAD_5},load_15_min=${LOAD_15},Distributor_ID=\"${ARRAY[0]}\",Description=\"${ARRAY[1]}\",Release=\"${ARRAY[2]}\",Codename=\"${ARRAY[3]}\"
"
